<?php
    ...
    $jumlah = mysqli_num_rows($get); /*menjalankan query pada variabel $get  dan menghitung jumlah seluruh kolom 
                                        pada tabel (karena data 1 mahasiswa berada dalam 1 kolom)*/
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                ...
                <form action="simpan.php" method="post"> <!-- dengan method post, data akan langsung dikirim ke database dan tidak akan kelihatan pada html -->
            ...
            <div class="col-lg-6">
                ...
                <!-- melakukan perulangan foreach untuk menampilkan setiap data nama, 
                kelas, dan alamat mahasiswa yang sudah diinput pada html -->
